...
def dashboard():
    ...
    return render_template("tablero.html", usuario=Usuario.get_por_id(data),mensajes_recividos = Mensaje.get_usuario_mensajes_recividos(data),usuarios = Usuario.get_todos(), mensajes_enviados=len(Mensaje.get_mensajes_enviados(data)))
